import { Dust, Fire, Splash } from './participles.js';
...
export class Rolling extends State {
    ...
    handleInput(input){
        this.game.particles.unshift(new Fire(this.game, this.game.player.x + this.game.player.width * 0.5, this.game.player.y + this.game.player.heigh * 0.5));
